...
<body <?php body_class(); ?>>
	<header class="header <?php echo (is_user_logged_in() ? "logined" : " ") ;?>">
        <div class="container-ca">
            <div class="row">
                <div class="col-xl-4 col-lg-3 d-flex align-items-center">
                    <div class="header__logo">
                        <a href="<?php echo home_url(); ?>"><img src="<?php echo SD_THEME_IMAGE_URI; ?>/logo.svg" alt="logo"></a>
                    </div>
                </div>
                <div class="col-xl-8 col-lg-9 d-flex justify-content-lg-end">
                    <div class="header__navs">
                        ...
                        <div class="header__sign">
                            <?php if( ! is_user_logged_in() ) : ?>
                                <ul class="unloglist">
                                    <li><a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>/edit-account"><?php _e('login', 'claroads') ?></a></li>
                                    <li><a href="<?php echo get_permalink( get_page_by_path( 'registration' ) ); ?>"><?php _e('registration', 'claroads') ?></a></li>
                                </ul>
                            <?php endif; ?>
                            <?php if( is_user_logged_in() ) : 
                            ...
                            <a href="<?php echo $button_link; ?>" class="adsbtn">
                                <?php _e('Order', 'claroads') ?>
                                <span></span>
                            </a>
                        </div>
                    </div>
            ...
            <button class="burger-btn">
                <img src="<?php echo SD_THEME_IMAGE_URI; ?>/burger.svg" alt="menu">
            </button>
        </div>
	</header>
	<div class="mobile-nav <?php echo (is_user_logged_in() ? "mobile-nav__logined" : " ") ;?> ">
        <div class="mob-nav__wrapp">
            <button class="closemenu">
                <img src="<?php echo SD_THEME_IMAGE_URI; ?>/close.svg" alt="close">
            </button>
            ...
            <?php endif; ?>
            <a href="<?php echo $button_link; ?>" class="adsbtn"><?php _e('Order', 'claroads') ?><span></span></a>
        </div>
    </div>
